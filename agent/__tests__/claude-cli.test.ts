...
describe("claude-cli.ts", () => {
  ...
  describe("buildClaudeArgs", () => {
    ...
    it("places system prompt last in argument array (new session)", () => {
    ...
    it("omits --system-prompt when resuming (session already has it)", () => {
      const args = buildClaudeArgs({
      ...
      expect(args).not.toContain("You are helpful.");
    });
