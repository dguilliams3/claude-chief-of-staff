  ...
  if (role === 'user') {
    return (
      <div className="flex justify-end">
        <div className="max-w-[85%] min-w-0 px-3.5 py-2 rounded-2xl rounded-br-sm bg-accent/15 border border-accent/20">
          <p className="font-body text-[0.9rem] text-primary break-words">{content}</p>
        </div>
      </div>
    );
  }
